...
export default function Header() {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 flex flex-col items-center pt-2 z-50">
      {/* Main Header */}
      <div className="w-[90%] max-w-[1600px]">
        <header className="py-4 px-6 flex items-center justify-between border-b-2 border-[hsl(333.3,71.4%,50.6%)] bg-[hsl(222.2,84%,4.9%)] rounded-2xl">
          {/* Logo */}
          <div className="flex items-center gap-8">
            <div className="h-6"><img src="/next.svg" alt="Next.js Logo" className="h-full brightness-0 invert" /></div>
            ...
            <nav>
              <ul className="flex gap-6 text-[#F2F2F2]">
                <li><a href="#" className="hover:text-[hsl(333.3,71.4%,50.6%)] transition-colors">Home</a></li>
                <li><a href="#" className="hover:text-[hsl(333.3,71.4%,50.6%)] transition-colors">About</a></li>
                <li><a href="#" className="hover:text-[hsl(333.3,71.4%,50.6%)] transition-colors">Services</a></li>
                <li><a href="#" className="hover:text-[hsl(333.3,71.4%,50.6%)] transition-colors">Contact</a></li>
              </ul>
            </nav>
          </div>

          {/* Auth Buttons oder Avatar mit Dropdown */}
          {session ? (
